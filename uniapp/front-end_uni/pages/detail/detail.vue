...
<view class="container-detail">
    ...
    <view style="width: 642rpx; height: 122rpx; display: block; box-sizing: border-box; left: NaNrpx; top: NaNrpx">
      <image class="avatar" style="position: relative; left: 0rpx; top: 24rpx; width: 68rpx; height: 66rpx; display: inline-block; box-sizing: border-box" :src="postDetail.avatarUrl" mode="cover"></image>
      <text class="userinfo-nickname" style="color: #000000; position: relative; left: 94rpx; top: -47rpx; font-size: 20px">
        {{postDetail.nickName}}</text>
    </view>
