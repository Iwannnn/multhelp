...
<block v-if="!hasUserInfo">
  ...
  <button type="primary" @tap="getUserProfile" style="width: 276rpx; height: 84rpx; display: block; box-sizing: border-box; left: 22rpx; top: -26rpx; position: relative">点击登录</button>
  </view>
