...
<view class="container">
  <view style="width: 750rpx; height: 100rpx; display: block; box-sizing: border-box; left: NaNrpx; top: NaNrpx">
    ...
    <input style="position: relative; width: 460rpx; height: 44rpx; left: 230rpx; top: -16rpx; font-size: 17px; display: block; box-sizing: border-box" @blur="titleInput" class="weui-input" placeholder="请输入求助的标题">
  </view>
  <view class="divLine"></view>
  <view style="width: 750rpx; height: 260rpx; display: block; box-sizing: border-box; left: NaNrpx; top: NaNrpx">
    <textarea style="width: 700rpx; height: 200rpx; display: block; position: relative; font-size: 17px; margin: auto; box-sizing: border-box; left: 0rpx; top: 30rpx" @blur="detailTextArea" placeholder="请在这里为你的求助进行详细的描述，比如在时间，具体事项。"></textarea>
  </view>
  <view class="divLine"></view>
  <view style="width: 750rpx; height: 100rpx; display: block; box-sizing: border-box; left: NaNrpx; top: NaNrpx">
    <text style="position: relative; left: 50rpx; top: 30rpx; font-size: 17px">分类</text>
    <picker @change="bindPickerChange" :value="category_index" :range="categories" style="position: relative; width: 460rpx; height: 44rpx; left: 230rpx; top: -16rpx; font-size: 17px; ">
  ...
  <view style="width: 750rpx; height: 100rpx; display: block; box-sizing: border-box; left: NaNrpx; top: NaNrpx">
    ...
    <input style="position: relative; width: 376rpx; height: 44rpx; left: 230rpx; top: -16rpx; font-size: 17px; display: block; box-sizing: border-box" @blur="addressInput" class="weui-input" placeholder="大概描述地址(可不输入)" :value="address">
  ...
  <view style="width: 750rpx; height: 100rpx; display: block; box-sizing: border-box; left: NaNrpx; top: NaNrpx">
    ...
    <input style="position: relative; width: 498rpx; height: 44rpx; left: 230rpx; top: -16rpx; font-size: 17px; display: block; box-sizing: border-box" type="digit" class="weui-input" @blur="priceInput" placeholder="请输入愿意支付的帮助金(可为0)">
  </view>
  <view class="divLine"></view>
  <view style="width: 750rpx; height: 100rpx; display: block; box-sizing: border-box; left: NaNrpx; top: NaNrpx">
    <text style="position: relative; left: 50rpx; top: 30rpx; font-size: 17px">电话</text>
    <input style="position: relative; width: 460rpx; height: 44rpx; left: 230rpx; top: -15rpx; font-size: 17px; display: block; box-sizing: border-box" type="number" class="weui-input" @blur="phoneInput" placeholder="请输入手机号码">
  ...
  <view class="section" style="width: 750rpx; height: 100rpx; display: block; box-sizing: border-box; left: NaNrpx; top: NaNrpx">
    ...
    <picker style="position: relative; width: 220rpx; height: 44rpx; left: 230rpx; top: -16rpx; font-size: 17px; display: block; box-sizing: border-box" mode="date" :value="need_date" :start="need_date" end="2031-05-01" @change="bindDateChange">
  ...
  <view class="section" style="width: 750rpx; height: 100rpx; display: block; box-sizing: border-box; left: NaNrpx; top: NaNrpx">
    ...
    <picker style="position: relative; width: 104rpx; height: 44rpx; left: 230rpx; top: -16rpx; font-size: 17px; display: block; box-sizing: border-box" mode="time" :value="need_time" :start="need_time" end="23:59" @change="bindTimeChange">
...
const {
  formatData
} = require("../../utils/util.js"); // pages/post/post.js
// pages/post/post.js
