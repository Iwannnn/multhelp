...
<view class="box" style="width: 750rpx; height: 69rpx; display: block; box-sizing: border-box; left: 0rpx; top: 0rpx">
  ...
  <view :class="category_idx==1?'selected-box-container':'box-container'" style="width: 187rpx; height: 69rpx; display: flex; box-sizing: border-box; left: 187rpx; top: -69rpx; position: relative">
