		...
		<view class="container-detail">
			<view style="width: 642rpx; height: 122rpx; display: block; box-sizing: border-box; left: NaNrpx; top: NaNrpx">
				<image
					...
					:src="publishUser.avatarUrl"
					mode="cover"
				></image>
				<text class="userinfo-nickname" style="color: #000000; position: relative; left: 94rpx; top: -47rpx; font-size: 20px">{{ publishUser.nickName }}</text>
			</view>
		...
		<view class="container-detail">
			<view style="width: 642rpx; height: 122rpx; display: block; box-sizing: border-box; left: NaNrpx; top: NaNrpx">
				<image
					class="avatar"
					style="position: relative; left: 0rpx; top: 24rpx; width: 68rpx; height: 66rpx; display: inline-block; box-sizing: border-box"
					:src="receiveUser.avatarUrl"
					mode="cover"
				></image>
				<text class="userinfo-nickname" style="color: #000000; position: relative; left: 94rpx; top: -47rpx; font-size: 20px">{{ receiveUser.nickName }}</text>
			</view>
...
/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbIiUzQ2lucHV0JTIwY3NzJTIwUk8tS01JJTNFIl0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiJBQUFBLHVDQUF1QyIsImZpbGUiOiJ0by5jc3MiLCJzb3VyY2VzQ29udGVudCI6WyIvKiBwYWdlcy9teS9teVBvc3QvZGV0YWlsL2RldGFpbC53eHNzICovIl19 */
</style>
